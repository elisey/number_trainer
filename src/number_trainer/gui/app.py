...
from .styles import get_fonts, setup_styles
...
class NumberTrainerApp:
    ...
    def create_widgets(self) -> None:
        ...
        # Title
        title_label = ttk.Label(main_frame, text="Number Trainer", font=fonts["title"])
        ...
        start_button = ttk.Button(
            button_frame, text="Начать тренировку", command=self.start_training
        )
